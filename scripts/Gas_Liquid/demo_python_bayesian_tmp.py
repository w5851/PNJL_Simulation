#usr/bin/env python3
"""
NOTICE: This demo file was moved to examples/Gas_Liquid/demo_python_bayesian_tmp.py
"""

import sys

print("This file has been moved to examples/Gas_Liquid/demo_python_bayesian_tmp.py")
sys.exit(0)
#!/usr/bin/env python3
"""
...
"""
    ...
    max_iterations = 150  # 恢复为原始演示的迭代次数以进行完整基准测试
