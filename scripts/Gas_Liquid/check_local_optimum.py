#!/usr/bin/env python3
"""
NOTICE: This file has been moved.

The original script `check_local_optimum.py` was moved to:
    examples/Gas_Liquid/check_local_optimum.py
...
print("This script has been moved to examples/Gas_Liquid/check_local_optimum.py")
sys.exit(0)
#!/usr/bin/env python3
"""
